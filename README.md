...
<h1 style="text-align: center;">ESG Violations</h1>
<div align="center">  <img src="TNG_ESG.png"></div>

# Description
ESG (Environmental, Social, Governance) is an emerging industry becoming increasingly popular in risk management, and with its popularity comes violations and fines in each of these areas. <br>
This repository contains links to sources that provide ESG-related violations and fines.
<br>
<br>
